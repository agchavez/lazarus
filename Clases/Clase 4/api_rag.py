"""
🚀 API FastAPI para RAG OpenAI V4
Integración completa del agente RAG V3 con FastAPI
...
CHUNK_OVERLAP = 100
TOP_K_DOCUMENTS = 3
CRM_DB_PATH = "crm_concesa_api.db"

# Perfil de configuración (puedes cambiarlo)
PERFIL_ACTIVO = "balanceado"
PERFILES = {
    "economico": {
        "model": "gpt-4o-mini",
        "temperature": 0.3,
...
# ============================================================================
# CLASE CHAT RAG V4 (ADAPTADA PARA API)
# ============================================================================
